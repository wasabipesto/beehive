...
Eventually [Zed](https://zed.dev/) (my editor of choice at the moment) came out with a new agent feature, so I took that for a spin. It was insane. I would copy over a section of my notes describing a planned feature and Claude would fully implement it better than I could. It would walk me through everything it did, write and run tests, and adapt if I had concerns. I use it all the time now. As of when I'm writing this (June 2025), I highly recommend the blog post [My AI Skeptic Friends Are All Nuts](https://fly.io/blog/youre-all-nuts/) by Thomas Ptacek as a thorough argument for "you should take this seriously".
